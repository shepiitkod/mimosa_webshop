...
urlpatterns = [
    ...
    path(
        "products/<int:product_id>/<slug:slug>/",
        views.product_detail_view,
        name="product_detail",
    ),
    path("products/bento/", views.product_bento_view, name="product_bento"),
    path(
        "products/decorative-candles/",
        views.product_rose_view,
    ...
    path(
        ...
        name="create_order_from_product",
    ),
    path(
        "orders/<int:order_id>/checkout/",
        views.create_checkout_session_for_order,
